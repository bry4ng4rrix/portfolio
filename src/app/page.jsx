  ...
  const services = [
    {
      ...
      description:
        "Applications React/Next.js avec Tailwind CSS, Material UI et shadcn",
    },
    {
      icon: <Globe className="w-8 h-8" />,
      title: "Développement Backend",
      description:
        "API-REST avec Python/Django ou Python/Fastapi et PHP pour des solutions robustes",
    },
    {
            ...
            <div className="hidden md:flex justify-center items-center text-foreground gap-1">
              {nav.map((nav, index) => (
                <motion.div
                  ...
                  key={index}
                >
                  <SmoothScrollButton to={nav.link}>
                    {nav.nom}
                  </SmoothScrollButton>
                </motion.div>
              ))}
      ...
      <section id="services" className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Je propose une gamme complète de services pour concrétiser vos
              projets digitaux.
            </p>
          </div>
      ...
      <section id="projects" className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Découvrez quelques-uns de mes projets récents qui illustrent mes
